            ...
            <div class="grow p-4 pt-1 md:p-4">
                ...
                <div class="text-sm md:text-base">
                    ...
                    <div class="mb-2">
                        ...
                        <span>service@groovydc.com.tw</span>
                        
                    </div>
                   <div class="mb-2">
                        <span  class="w-4 inline-block mr-2"><img src="img/iconAddress.png" alt=""></span>
                        <span>3F., No. 66, Shijian Rd., Banqiao Dist., New Taipei City 220 , Taiwan</span>
                    </div>
                </div>
            </div>
        </div>
